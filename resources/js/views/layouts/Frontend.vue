        ...
        <header>
            <nav class="relative px-6 py-6 flex justify-between items-center bg-white">
                ...
                <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                    <li><a class="text-sm text-gray-400 hover:text-gray-500">Start</a></li>
                    ...
                    <li><a class="text-sm text-green-600 font-bold">About Us</a></li>
                    <li class="text-gray-300">
                        <svg class="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
                        </svg>
                    ...
                    <li>
                        <router-link class="text-sm text-gray-400 hover:text-gray-500" :to="{name: 'PostsIndex'}">
                            Blog
                        </router-link>
