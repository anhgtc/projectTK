<template>
    <div>
                    ...
                    <div class="bg-white shadow-md rounded my-6">
                        <table class="min-w-max w-full table-auto text-center ">
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                <tr v-for="(category, index) in categories" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <router-link :to="{name:'BackendCategoriesEdit', params:{id: category.id}}">
        ...
        <router-link class="fixed bottom-10 right-10" :to="{name:'BackendCategoriesCreate'}">
...
export default {
    ...
    created() {
        ...
        axios
            ...
            .then((result) => {
                console.log(result)
                if (result.status == 200) this.categories = result.data.categories;
                else alert('That bai')
            })
            .catch((error) => {
    ...
    methods: {
        deleteCategory($id, $index) {
            let url = "/api/admin/categories/delete/" + $id;
            axios
                .post(url)
                .then((result) => {
